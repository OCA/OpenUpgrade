    ...
    if aml_ids2:
        ...
        if ail_ids:
            openupgrade.logged_query(
                ...
                ail.create_uid, ail.create_date, ail.write_uid, ail.write_date, am.state
                FROM account_invoice_line ail
...
def migration_voucher_moves(env):
    ...
    openupgrade.logged_query(
        ...
        date, create_uid, create_date, write_uid, write_date, parent_state)
        ...
        COALESCE(am.date, avl.create_date), avl.create_uid, avl.create_date, avl.write_uid, avl.write_date, am.state
        FROM account_voucher_line avl
