...
xmlid_renames = [
    ...
    ('sale.process_node_deliveryorder0',
     'sale_stock.process_node_deliveryorder0'),
    ('sale.process_node_invoiceafterdelivery0',
     'sale_stock.process_node_invoiceafterdelivery0'),
    ('sale.process_node_packinglist0', 'sale_stock.process_node_packinglist0'),
    ('sale.process_node_saleorderprocurement0',
     'sale_stock.process_node_saleorderprocurement0'),
    ('sale.process_node_saleprocurement0',
     'sale_stock.process_node_saleprocurement0'),
    ('sale.process_transition_deliver0',
     'sale_stock.process_transition_deliver0'),
    ('sale.process_transition_invoiceafterdelivery0',
     'sale_stock.process_transition_invoiceafterdelivery0'),
    ('sale.process_transition_packing0',
     'sale_stock.process_transition_packing0'),
    ('sale.process_transition_saleorderprocurement0',
     'sale_stock.process_transition_saleorderprocurement0'),
    ('sale.process_transition_saleprocurement0',
     'sale_stock.process_transition_saleprocurement0'),
    ('sale.process_transition_action_assign0',
     'sale_stock.process_transition_action_assign0'),
    ('sale.process_transition_action_cancel1',
     'sale_stock.process_transition_action_cancel1'),
    ('sale.process_transition_action_cancel2',
     'sale_stock.process_transition_action_cancel2'),
    ('sale.process_transition_action_cancelassignation0',
     'sale_stock.process_transition_action_cancelassignation0'),
    ('sale.process_transition_action_forceassignation0',
     'sale_stock.process_transition_action_forceassignation0'),
    ('sale.process_transition_action_validate0',
     'sale_stock.process_transition_action_validate0'),
]
