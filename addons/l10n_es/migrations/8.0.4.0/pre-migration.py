...
models = [
    ...
    # Not possible because it's still linked to account.account
...
def remove_data(cr):
    """This is done as a hack/trick, because data are in a noupdate section
    and foreign keys avoids to do it in any other way.
    """
    # Delete data
    for model in models:
