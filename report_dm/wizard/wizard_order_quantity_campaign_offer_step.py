...
_order_quantity_campaign_offer_step_form = """<?xml version="1.0"?>
...
_order_quantity_campaign_offer_step_fields = {
...
class wizard_qty_campaign_offer_step_report(wizard.interface):
    states = {
        'init': {
            'actions': [_get_value],
            'result': {'type':'form', 'arch':_order_quantity_campaign_offer_step_form, 'fields':_order_quantity_campaign_offer_step_fields, 'state':[('end','Cancel'),('print','Print Report')]},
        },
        'print': {
            'actions': [],
            'result': {'type':'print', 'report':'dm.order.quantity.campaign.offer.step', 'state':'end'},
        },
    }
wizard_qty_campaign_offer_step_report('dm.order.quantity.campaign.offer.step')
