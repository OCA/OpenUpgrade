...
#                    + line +  ' <br /> Number of customer invoice : ' + str(number_customer_inv or 0 ) + '<br/>' + line+' <br /> Number of supplier invoice : ' + str(number_supplier_inv or 0)  + '<br/>' +line +'<br />Total Receivable : ' + str(part.credit) + '<br/>' + line+' <br/>Total Payable : ' + str(part.debit) + '<br/>' + line+ '<br/>Website : ' + str(part.website or '') + '<br/>' +line+ ' </b> </font> </head></html>'
        ...
        desc_text = ' <html><head> <font color="red"> <b><table border=10 bordercolor="red"><tr><td> Partner Name:</td><td>' + str(part.name) + '</td></tr><tr>' + '<td> Partner Code:</td><td> ' + str(part.ref or '') + '</td></tr>' + '<tr><td>Type:</td><td>' + type + '</td></tr><tr><td>' + 'Partner Address: </td><td>' +  address + '</td></tr>' + '<tr><td>Turnover of partner:</td><td> ' + str(res[part.id]) + '</td></tr>' + ' <tr><td> Main comapny:</td><td>' + str(part.parent_id and part.parent_id.name) + '</td></tr>' + '<tr><td>Credit Limit:</td><td>' + str(part.credit_limit or 'Nill') + '</td></tr>' \
            +  '<tr><td>Number of customer invoice:</td><td>' + str(number_customer_inv or 0 ) + '</td><tr>' +' <tr><td>Number of supplier invoice:</td><td>' + str(number_supplier_inv or 0) + '</td></tr>'  + '<tr><td>' +'Total Receivable:</td><td> ' + str(part.credit or 'Nill') + '</td></tr>' +' <tr><td>Total Payable:</td><td>' + str(part.debit or 'Nill') + '</td></tr>' + '<tr><td>Website:</td><td>' + str(part.website or '') + '</td></tr>'+ '</table> </b> </font> </head></html>'
