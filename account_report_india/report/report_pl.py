...
class report_pl(report_sxw.rml_parse):
    def __init__(self, cr, uid, name, context):
        super(report_pl, self).__init__(cr, uid, name, context)
...
report_sxw.report_sxw('report.pl', 'account.report.india',
    'addons/account_report_india/report/report_pl.rml',parser=report_pl,
    header=False)
