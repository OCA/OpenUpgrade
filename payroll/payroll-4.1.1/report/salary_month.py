...
class salary_print(report_sxw.rml_parse):
    ...
    def _lst_payelems(self, employee_id, month, year):
        self.cr.execute('select name as descr, cal_value as value, arrear, incr_id, incr_date from employee_setup_payelements where employee_id=%d and element_type=payelements order by id', (employee_id) )
