...
##############################################################################
{
    ...
    'update_xml': [
	 ...
	 'etl_interface/etl_component/transform/data_filter_view.xml',
	 'etl_interface/etl_component/transform/logger_bloc_view.xml',
	 'etl_interface/etl_component/transform/logger_view.xml',
	 'etl_interface/etl_component/transform/map_view.xml',
