...
class etl_component_sugarcrm_in(osv.osv):
    _name='etl.component'
    _inherit = 'etl.component'

    _columns={
               'module_name': fields.char('Module Name', size=64),
            }

    def create_instance(self, cr, uid, id, context={}, data={}):
        val = super(etl_component_sugarcrm_in, self).create_instance(cr, uid, id, context, data)
        ...
        if cmp.type_id.name == 'input.openobject_in':
            ...
            val = etl.component.input.sugarcrm_in(conn_instance, cmp.module_name, cmp.name, trans_instance, cmp.row_limit)
        return val

etl_component_sugarcrm_in()
