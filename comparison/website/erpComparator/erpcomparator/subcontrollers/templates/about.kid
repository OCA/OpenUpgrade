...
<body>
	<table id="bodybackground" style="padding: 5px; text-align: justify; width: 890px;">
		<tr>
			<td>
				<div id="checkboxtext" style="font-family: Verdana, Geneva, sans-serif; font-style: normal; font-size: 12px;">
					<b>Introduction</b><br/>
