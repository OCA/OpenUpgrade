...
class report_generalize_horizontal(rml_parse.rml_parse):
    def __init__(self, cr, uid, name, context):
        super(report_generalize_horizontal, self).__init__(cr, uid, name, context)
        self.res_pl={}
...
report_sxw.report_sxw(
    'report.generalize.horizontal',
    'generalize.account.report',
    'generalize_account_report/report/report_generalize_horizontal.rml',
    parser=report_generalize_horizontal, header=False
)
