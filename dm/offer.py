...
class dm_customer_file(osv.osv):
    ...
    _columns = {
        ...
        'broker_id' : fields.many2one('res.partner', 'Broker', domain=[('category_id','ilike','Broker')]),
...
class dm_offer(osv.osv):
    ...
    _columns = {
        ...
        'copywriter_id' : fields.many2one('res.partner', 'Copywriter',domain=[('category_id','ilike','Copywriter')]),
        ...
        'recommended_trademark' : fields.many2one('res.partner','Recommended Trademark'),
