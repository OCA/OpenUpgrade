...
#
        ...
        'read_dtp_request_date' :fields.date('Read Request Date'),
        ...
        'read_translation_delivery_date' :fields.date('Read Translation Date'), 
        ...
        'read_translation_rereading_date' :fields.date('Read Translation Rereading Date'),
        ...
        'read_draft_delivery_date' : fields.date('Read Draft Delivery Date'),
        ...
        'read_fcp_validation_date' : fields.date('Read Fcp Validation Date'),
        ...
        'read_dtp_sup_delivery_date' : fields.date('Read Dtp Sup Delivery Date'),
