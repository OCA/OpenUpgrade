...
def dynamic_text(cr,uid,ref_text_id,**args):
    ...
    dynamic_text_id = pool.get('dm.dynamic_text').search(cr,uid,[('language_id','=',lang_id),('gender_id','=',gender_id),('ref_text_id','=',ref_text_id),('previous_step_id','=',args['previous_step_id'])])
    if dynamic_text_id :
