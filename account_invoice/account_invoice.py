...
#    def onchange_payment_term_date_invoice(self, cr, uid, ids, payment_term_id, date_invoice,latest_date):
#        if not payment_term_id:
#            return {}
#        if not latest_date:
#            latest_date = self._defaults["latest_date"](cr,uid,{})
#        res={}
...
#        res={'value':{'latest_date':str(data3)}}
#        print'::::::::::::res::::::::::::;',res
#        return res
...
#            vals['latest_date']=time.strftime("%Y-%m-%d %H:%M:%S")
#        id = super(account_invoice, self).write(cr, uid, ids, vals, context=context)
#        return id
