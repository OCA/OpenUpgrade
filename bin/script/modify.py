        ...
        if not docinfo.getUserFieldValue(3)=="":
            if self.oVC.TextField:
                ...
                if self.oMyObject.__getitem__(0) == "field":
                    #print self.oMyObject.__getitem__(1).__getslice__(self.oMyObject.__getitem__(1).find("."),self.oMyObject.__getitem__(1).__len__()).replace(".","/")
                    #print self.oMyObject.__getitem__(1).__getslice__(0,self.oMyObject.__getitem__(1).find("."))
                    #print self.oCurObj.Items[0]
