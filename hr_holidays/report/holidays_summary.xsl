		...
		<document filename="example.pdf">
			...
			<stylesheet>
				...
				<blockTableStyle id="month1">
					 ...
					 <blockBackground colorName="#FF0000" start="0,0" stop="-1,-1"/>
					 <blockValign value="TOP"/>
				</blockTableStyle>
				<blockTableStyle id="month2">
					 <blockAlignment value="CENTER" start="0,0" stop="-1,-1"/>
					 <blockBackground colorName="#FFFF00" start="0,0" stop="-1,-1"/>
					 <blockValign value="TOP"/>
				</blockTableStyle>
				...
				<blockTableStyle id="legend">
					...
					<xsl:for-each select="/report/legend[@id='1']">
						<blockBackground>
							<xsl:attribute name="colorName">red</xsl:attribute>
					...
					<xsl:for-each select="/report/legend[@id='2']">
						<xsl:variable name="row" select="attribute::id" />
						<blockBackground>
							<xsl:attribute name="colorName">green</xsl:attribute>
							<xsl:attribute name="start">
					...
					<xsl:for-each select="/report/legend[@id='3']">
						<xsl:variable name="row" select="attribute::id" />
						<blockBackground>
							<xsl:attribute name="colorName">blue</xsl:attribute>
							<xsl:attribute name="start">
					...
					<xsl:for-each select="/report/legend[@id='4']">
						<xsl:variable name="row" select="attribute::id" />
						<blockBackground>
							<xsl:attribute name="colorName">yellow</xsl:attribute>
							<xsl:attribute name="start">
					...
					<xsl:for-each select="/report/legend[@id='5']">
						<xsl:variable name="row" select="attribute::id" />
						<blockBackground>
							<xsl:attribute name="colorName">cyan</xsl:attribute>
							<xsl:attribute name="start">
					...
					<xsl:for-each select="/report/legend[@id='6']">
						<xsl:variable name="row" select="attribute::id" />
						<blockBackground>
							<xsl:attribute name="colorName">magenta</xsl:attribute>
							<xsl:attribute name="start">
				...
				<blockTableStyle id="month">
					...
					<xsl:for-each select="/report/info[@val='1']">
					...
					<xsl:for-each select="/report/info[@val='2']">
						<xsl:variable name="col" select="attribute::number" />
						<xsl:variable name="row" select="attribute::id" />
						<blockBackground>
							<xsl:attribute name="colorName">green</xsl:attribute>
					...
					<xsl:for-each select="/report/info[@val='3']">
						<xsl:variable name="col" select="attribute::number" />
						<xsl:variable name="row" select="attribute::id" />
						<blockBackground>
							<xsl:attribute name="colorName">blue</xsl:attribute>
					...
					<xsl:for-each select="/report/info[@val='4']">
						<xsl:variable name="col" select="attribute::number" />
						<xsl:variable name="row" select="attribute::id" />
						<blockBackground>
							<xsl:attribute name="colorName">yellow</xsl:attribute>
					...
					<xsl:for-each select="/report/info[@val='5']">
						<xsl:variable name="col" select="attribute::number" />
						<xsl:variable name="row" select="attribute::id" />
						<blockBackground>
							<xsl:attribute name="colorName">cyan</xsl:attribute>
					...
					<xsl:for-each select="/report/info[@val='6']">
						<xsl:variable name="col" select="attribute::number" />
						<xsl:variable name="row" select="attribute::id" />
						<blockBackground>
							<xsl:attribute name="colorName">magenta</xsl:attribute>
