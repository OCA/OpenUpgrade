...
class GeneralLedger(report_sxw.rml_parse):
	...
	def lines(self, account, form):
		...
		sSQL = "SELECT l.date, j.code, p.name as pname, a.name as aname, l.ref, l.name, l.debit, l.credit "\
			"FROM account_move_line l, account_journal j, res_partner p, account_account a "\
			"WHERE l.journal_id = j.id AND l.partner_id = p.id AND l.account_id = a.id "\
...
report_sxw.report_sxw(
	...
	'account.account', 
	'addons/account_india_ledger/report/general_ledger.rml', 
