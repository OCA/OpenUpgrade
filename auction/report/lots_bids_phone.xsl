...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format">
	...
	<xsl:template match="lots">
		<document xmlns:fo="http://www.w3.org/1999/XSL/Format">
			<template leftMargin="2.0cm" rightMargin="2.0cm" topMargin="2.0cm" bottomMargin="2.0cm" title="Releve de compte" author="Generated by Tiny ERP, Fabien Pinckaers" allowSplitting="20" pageSize="(29.7cm,21cm)">
			...
			<story>
				<blockTable repeatRows="1" style="left" colWidths="1.8cm,11.0cm,2.3cm,10.5cm">
					...
					<xsl:apply-templates select="lot[count(bid[tocall='1'])>0]"/>
				</blockTable>
			</story>
		</document>
	</xsl:template>

	<xsl:template match="lot[count(bid[tocall='1'])>0]">
		<tr>
			<td>
